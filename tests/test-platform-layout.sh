...
contains dot_config/mise/conf.d/00-base.toml.tmpl '"jundot/omlx" = "https://github.com/jundot/omlx"'
contains dot_config/mise/conf.d/00-base.toml.tmpl '"brew:jundot/omlx/omlx" = "latest"'
...
contains dot_config/mise/conf.d/00-base.toml.tmpl 'oMLX bundles MLX and mlx-lm'
