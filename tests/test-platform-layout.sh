...
contains .chezmoiignore '.config/sol/'
...
contains dot_aerospace.toml "if.app-id = 'com.ospfranco.sol'"
contains dot_config/sol/config.json.tmpl '"disabledItemIds"'
contains dot_config/sol/config.json.tmpl '"move_to_next_space"'
...
not_contains dot_config/mise/conf.d/00-base.toml.tmpl '"jundot/omlx" = "https://github.com/jundot/omlx"'
not_contains dot_config/mise/conf.d/00-base.toml.tmpl '"brew:jundot/omlx/omlx" = "latest"'
contains dot_config/mise/conf.d/00-base.toml.tmpl '[tasks."omlx:model:install"]'
contains dot_config/mise/conf.d/00-base.toml.tmpl '[tasks."omlx:start"]'
contains dot_config/mise/conf.d/00-base.toml.tmpl '"$hf" download "mlx-community/Qwen3-4B-4bit"'
contains dot_config/mise/conf.d/00-base.toml.tmpl 'omlx start'
contains dot_config/mise/conf.d/00-base.toml.tmpl 'model_revision="4dcb3d101c2a062e5c1d4bb173588c54ea6c4d25"'
contains dot_config/mise/conf.d/00-base.toml.tmpl 'revision_file="$model_dir/.omlx-revision"'
contains dot_config/mise/conf.d/00-base.toml.tmpl 'oMLX is intentionally not managed here'
contains dot_config/mise/conf.d/00-base.toml.tmpl 'for command_name in mise aerospace voxtype omlx'
contains .chezmoiignore '.pi/agent/models.json'
contains dot_pi/agent/models.json 'qwen3-4b-4bit'
contains dot_pi/agent/models.json 'http://127.0.0.1:8000/v1'
...
contains dot_config/mise/conf.d/00-base.toml.tmpl '"brew-cask:sol" = "latest"'
...
contains dot_pi/agent/extensions/joyful-workflow.ts 'active: false'
contains dot_pi/agent/extensions/joyful-workflow.ts 'if (!state.active || !["write", "edit"].includes(event.toolName)) return;'
contains dot_pi/agent/skills/joyful-workflow/SKILL.md 'Joyful is opt-in'
contains dot_pi/agent/AGENTS.md 'Matt skills are the default workflow'
